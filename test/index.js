...
var aTestSetupQueries = [
    ...
    'CREATE TABLE `scribbles` (`id` int(11) NOT NULL AUTO_INCREMENT, `batchId` int(11) unsigned DEFAULT NULL, `text` text, PRIMARY KEY (`id`), KEY `fk_batchId_idx` (`batchId`), CONSTRAINT `fk_batchId` FOREIGN KEY (`batchId`) REFERENCES `batches` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION) ENGINE=InnoDB DEFAULT CHARSET=utf8',
