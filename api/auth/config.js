module.exports = {
    ...
    FACEBOOK_REDIRECT_URL: process.env.MODE === 'production' ? 'https://tutorbuddy.logicbomb.in/auth/facebook/redirect' : 'http://localhost:8080/auth/facebook/redirect', //'https://tutor-buddy.appspot.com/auth/facebook/callback',
    ...
    FACEBOOK_TOKEN_REDIRECT_URL: process.env.MODE === 'production' ? 'https://tutorbuddy.logicbomb.in/auth/facebook/handle_token' : 'http://localhost:8080/auth/faceook/handle_token',
